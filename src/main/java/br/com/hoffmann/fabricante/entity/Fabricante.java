package br.com.hoffmann.fabricante.entity;
...
public class Fabricante {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY, generator = "SQ_FABRICANTE")
    @SequenceGenerator(sequenceName = "SQ_FABRICANTE", allocationSize = 1, name = "SQ_FABRICANTE")
    @Column(name = "ID")
    private Long id;
